...
type Options struct {
	...
	RaftAddress          string   `flag:"raft-address"`
	ClusterRaftAddresses []string `flag:"cluster-raft-address" cfg:"cluster_raft_addresses"`

	BroadcastAddress         string        `flag:"broadcast-address"`
	BroadcastTCPPort         int           `flag:"broadcast-tcp-port"`
	BroadcastHTTPPort        int           `flag:"broadcast-http-port"`
	XMQLookupdGrpcAddresses  []string      `flag:"lookupd-grpc-address" cfg:"xmqlookupd_grpc_addresses"`
...
func NewOptions() *Options {
	...
	return &Options{
		...
		ClusterRaftAddresses: make([]string, 0),
		BroadcastAddress:     hostname,
		BroadcastTCPPort:     0,
		BroadcastHTTPPort:    0,

		XMQLookupdGrpcAddresses: make([]string, 0),
